...
This project aims to implement an ASP.NET Core Web API that should serve a webshop revolving around musical instruments. 🥁

# ✨ Current features
* API endpoints for creating categories and instruments
